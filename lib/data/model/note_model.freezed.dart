...
class _$NoteModelImpl implements _NoteModel {
  ...
  @override
  String toString() {
    return 'NoteModel(id: $id, title: $title, description: $description, schedule: $schedule, isDone: $isDone)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, schedule, isDone);
...
abstract class _NoteModel implements NoteModel {
  factory _NoteModel(
      ...
      final String? description,
      final DateTime? schedule,
      final bool isDone}) = _$NoteModelImpl;
